...

{
  ...
  "clutter_to_remove": ["liste d'éléments visibles parasites à idéalement retirer pour la version brand. Inclure : câbles électriques, prises, gobelets/bouteilles/serviettes oubliés, jouets de plage (sceau/seau, pelle, ballon, jouets plastique colorés), sacs/sandales/affaires personnelles éparpillées, panneaux/posters, détritus, rubans de chantier (hazard tape, construction tape), barrières DE CHANTIER (orange plastique, plots, balisage temporaire), hose / tuyaux d'arrosage qui traînent, extincteurs muraux, eyesores techniques : caméras de surveillance / CCTV, escaliers de secours sur bâtiments voisins, antennes / paraboles, climatiseurs extérieurs / unités AC, gaines de ventilation, grilles techniques, drains visibles, ET AUSSI les LOGOS de marques tierces (sur parasols, coussins, serviettes, panneaux, mobilier — sauf le branding sobre de l'hôtel lui-même). Liste 1 ligne par objet, max 6. Vide si rien. \n\n⛔ NE JAMAIS LISTER COMME CLUTTER (éléments structurels ou de sécurité à GARDER) :\n- Cocktails / plats servis sur table dressée (aspirationnel)\n- Mobilier hôtelier (transats, daybeds, parasols, tables, chaises, sofas) — seul le LOGO posé dessus pose problème, pas le mobilier\n- **Barrières DE SÉCURITÉ permanentes** : pool fences (vitrées, métalliques, grillagées), spa safety barriers, garde-corps de rooftop/balcon/terrasse, balustrades. Ces éléments sont OBLIGATOIRES légalement et leur retrait casse la photo (la piscine paraît sans protection ⇒ red flag liability). PAR DÉFAUT toute barrière fixe entourant piscine/spa/terrasse en hauteur est à GARDER.\n- Escaliers de la piscine, rampes d'accès à l'eau, échelles fixes\n- Mains courantes / handrails de marches\n- **Bouées gonflables décoratives** (flamant rose, licorne, donut, ananas, pastèque, cygne, avocat, anneau pastel, etc.) — c'est exactement le type d'élément playful qu'on AJOUTE volontairement via le pipeline pour l'effet 'instagrammable' Dayuse. Les retirer va à l'encontre de la stratégie brand. Elles RESTENT dans la photo. Seule exception : bouée hors d'usage abandonnée sur le carrelage (pas dans l'eau) avec aspect 'à jeter' (dégonflée, sale, percée) → peut être listée. Une bouée en bon état dans l'eau est ASPIRATIONNELLE et reste.""],
