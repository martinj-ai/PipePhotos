...

{
  ...
  "safe_zones_for_humans": {
    "safe_areas": ["liste descriptive précise des zones existantes où l'on POURRAIT plausiblement placer un humain — ex: 'transats vides au premier plan à gauche', 'le sol carrelé devant la cabana', 'IN the pool (swimming, wading)', 'sur les chaises de la table dressée'"],
    "unsafe_areas": ["zones À ÉVITER pour cette photo précise — ex: 'la surface de l'eau de la piscine (impossible)', 'derrière la barrière de sécurité', 'sur le toit du daybed'"],
    "max_recommended": "nombre maximum recommandé d'humains pour cette scène (1-3 selon l'espace dispo)"
  },
  "clutter_to_remove": ["liste d'éléments visibles parasites à idéalement retirer pour la version brand. Inclure : câbles électriques, prises, gobelets/bouteilles/serviettes oubliés, jouets de plage (sceau/seau, pelle, ballon, jouets plastique colorés), sacs/sandales/affaires personnelles éparpillées, panneaux/posters, détritus, barrières, hose, extincteurs muraux, ET AUSSI les eyesores techniques visibles : caméras de surveillance / CCTV, escaliers de secours sur bâtiments voisins, antennes / paraboles, climatiseurs extérieurs / unités AC, gaines de ventilation, grilles techniques, drains visibles. Liste 1 ligne par objet, max 6. Vide si rien. NE PAS lister un cocktail/plat servi sur table dressée (ce n'est pas du clutter, c'est aspirationnel). NE PAS lister du mobilier hôtelier (transats, daybeds, parasols, tables) même s'il semble ordinaire."],
  "recommended_crop": {
    "should_crop": false,
    "x_min_pct": 0,
    "y_min_pct": 0,
